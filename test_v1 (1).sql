...
INSERT INTO `buy` (`byID`, `id`, `productID`, `productNUM`) VALUES
(3, 1, 25, 3),
(4, 1, 11, 2);
...
INSERT INTO `product` (`productID`, `nationID`, `productName`, `productPrice`, `Information`) VALUES
...
(1, 'aaa@gmail.com', '$2a$08$DeK4sGapLNoZmknS9osHxeGYvVgN43tobBL6.8BGf4dd25t1xw7tm'),
(2, 'bbb@gmail.com', '$2a$08$YzOGcclAVmydR5IfBmg4o.y44yXXzpYwt2gGjRFT.N38fJOTBzdZy'),
(3, 'ccc@gmail.com', '$2a$08$7aUkjT91xI2gyp5m/Datr.NKHjRcrcro7/T2XHhpaqSxeUFINgjxq'),
(4, 'ddd@gmail.com', '$2a$08$QLSdESTgXsVnEqxtxLm5YuinjfsvzjkphkgLfC3shTqTGFqoqgSDq');
...
--
ALTER TABLE `buy`
  MODIFY `byID` int(4) NOT NULL AUTO_INCREMENT COMMENT '主鍵', AUTO_INCREMENT=5;
