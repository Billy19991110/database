...
INSERT INTO `users` (`users_id`, `name`, `email`, `password`, `imageUrl`, `date`) VALUES
(2, '宇勝陳', 'tea551234@gmail.com', '109743956245694159928', 'https://lh3.googleusercontent.com/a/AATXAJxIsD-yI2k_ADTi_6r-7R5yESVM_007YaJPvL0U=s96-c', '2022-02-18 08:00:22'),
(3, '茶耶', 'ggbbhhnn15@gmail.com', '115804666636627367647', 'https://lh3.googleusercontent.com/a-/AOh14GjDCHIHQRz_DnlkByrSRsU-1cUofpcF1iIbuDjukw=s96-c', '2022-02-18 08:13:31');
...
--
ALTER TABLE `product`
  MODIFY `productID` int(11) NOT NULL AUTO_INCREMENT COMMENT '產品ＩＤ', AUTO_INCREMENT=58;
...
ALTER TABLE `buy`
  ...
  ADD CONSTRAINT `buy_ibfk_3` FOREIGN KEY (`users_id`) REFERENCES `users` (`users_id`);
